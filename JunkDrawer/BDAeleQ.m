classdef BDAeleQ < handle
    %The 1D linear element class for WOOFE
    ...
    methods
        ...
        function thisEle = BDAeleQ(numIn, nodeInfo, constIn, fIn, gs4)
        ...
        function [] = updateEleJ(ele,gs4)         
            ...
            ele.toJ{2} = gs4.lam5w2/gs4.lam3/gs4.dt*eleC;
